...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL  , KC_LCTL  , KC_LALT  , KC_LGUI,LT(1,KC_LNG2),MT_SS    ,LT(3,KC_LNG1),           KC_BSPC,LT(2,KC_ENT)                               , KC_RALT  , KC_RALT(KC_SPC)
  ),

  [1] = LAYOUT(
    _______  , S(KC_1)  , S(KC_2)  , S(KC_3)  , S(KC_4)  , S(KC_5)  ,                                  KC_EQL   , S(KC_6)  ,S(KC_QUOT), S(KC_8)  , S(KC_9)  ,S(KC_INT1),
  ...
  [2] = LAYOUT(
    ...
    _______  , _______  , KC_7     , KC_8     , KC_9     , _______  ,                                  KC_PGUP  , KC_DOWN  , _______  , KC_F11   , KC_F12   , DF(2)   ,
    _______  , _______  , KC_4     , KC_5     , KC_6     ,S(KC_SCLN),                                  KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , _______  , _______ ,
    _______  , _______  , KC_1     , KC_2     , KC_3     ,S(KC_MINS), S(KC_8)  ,            S(KC_9)  , _______  , KC_BTN1  , KC_BTN1  , KC_BTN2  , KC_BTN3  , MO(3)   ,
    _______  , _______  , KC_0     , KC_DOT   , _______  , _______  , _______  ,             KC_DEL  , _______                                   , _______  , KC_PSCR
  ),

  [3] = LAYOUT(
    RGB_TOG  , _______  , _______  , _______  , _______  , _______  ,                                  CPI_D1K  , CPI_D100 , CPI_I100 , CPI_I1K  , KBC_SAVE  , KBC_RST  ,
    RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAI  , _______  , _______  ,                                  _______  , SCRL_DVI , SCRL_DVD , _______  , _______  , _______  ,
    RGB_RMOD , RGB_HUD  , RGB_SAD  , RGB_VAD  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , SCRL_MO  , SCRL_TO  , _______  ,            _______  , _______  , KC_BTN1  , KC_BTN1  , KC_BTN2  , KC_BTN3  , _______  ,
